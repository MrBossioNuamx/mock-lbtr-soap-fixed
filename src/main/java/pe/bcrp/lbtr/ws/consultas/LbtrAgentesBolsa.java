...
/**
 * <p>Clase Java para lbtr_AgentesBolsa complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="lbtr_AgentesBolsa"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "lbtr_AgentesBolsa", propOrder = {
    "sid"
})
public class LbtrAgentesBolsa {
